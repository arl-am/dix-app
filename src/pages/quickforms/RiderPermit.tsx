      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="flex justify-end gap-3 animate-fade-in-up" style={{ animationDelay: '170ms' }}>
          ...
          <button onClick={() => {
            ...
            if (!form.riderFirstName?.trim()) { toast.error('Rider First Name is required'); return; }
            if (!form.riderLastName?.trim()) { toast.error('Rider Last Name is required'); return; }
            toast.success('Rider Permit PDF generated!');
          }} className="inline-flex items-center justify-center gap-2 rounded-lg text-sm font-medium h-9 px-4 py-2 bg-[#2563EB] text-white transition-all duration-200 hover:bg-[#1D4ED8] hover:shadow-lg hover:shadow-primary/25 active:scale-95">
