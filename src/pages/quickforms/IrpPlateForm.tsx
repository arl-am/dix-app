    ...
    <div className="p-6 animate-fade-in-up">
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="flex justify-end gap-3 animate-fade-in-up" style={{ animationDelay: '170ms' }}>
          ...
          }} className="inline-flex items-center justify-center gap-2 rounded-lg text-sm font-medium h-9 px-4 py-2 bg-[#10B981] text-white transition-all duration-200 hover:bg-[#059669] hover:shadow-lg hover:shadow-emerald-500/25 active:scale-95">
