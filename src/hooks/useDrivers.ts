...
async function fetchDrivers(): Promise<Driver[]> {
  ...
  const [driversResult, unitsResult] = await Promise.all([
    Cr6cd_dix_driversService.getAll({
      select: [
        ...
        'cr6cd_dix_isactive', 'cr6cd_dix_onboardingdate', 'createdon', 'modifiedon',
        ...
        'cr6cd_tenstreetdriverid', 'cr6cd_lasttenstreetsync',
        '_cr6cd_dix_agent_value', '_cr6cd_dix_unit_value', '_cr6cd_dix_vendor_value',
  ...
  return drivers.map((d: any) => {
    ...
    return {
      ...
      cr6cd_dix_modifiedbyname: d['_modifiedby_value@OData.Community.Display.V1.FormattedValue'] || '',
